...
{
document.getElementById("gradepred").innerHTML = "Please select Total credits for the course.";
...
if((tc+lc+jc)==0)
{
document.getElementById("gradepred").innerHTML = "Please select any one of the components(Theory, lab or J-comp) for the course you have choosen.";
document.getElementById("gradepred1").innerHTML = "";
document.getElementById("gradepred2").innerHTML = "";
document.getElementById("gradepred3").innerHTML = "";
document.getElementById("gradepred4").innerHTML = "";
...
{
  document.getElementById("gradepred").innerHTML = "Your course credits are not matched with the selected components";
  document.getElementById("gradepred1").innerHTML = "";
document.getElementById("gradepred2").innerHTML = "";
document.getElementById("gradepred3").innerHTML = "";
document.getElementById("gradepred4").innerHTML = "";
  ...
  if((tc>0) && (Number.isNaN(cat1) || Number.isNaN(cat2) || Number.isNaN(da1) || Number.isNaN(da2) || Number.isNaN(da3) || Number.isNaN(tfat))){
              ...
              document.getElementById("gradepred").innerHTML="All entries are not filled in Theory component.";
              document.getElementById("gradepred1").innerHTML = "";
           document.getElementById("gradepred2").innerHTML = "";
         document.getElementById("gradepred3").innerHTML = "";
            document.getElementById("gradepred4").innerHTML = "";
             ...
             document.getElementById("gradepred").innerHTML="All entries are not filled in Lab component.";
             document.getElementById("gradepred1").innerHTML = "";
           document.getElementById("gradepred2").innerHTML = "";
          document.getElementById("gradepred3").innerHTML = "";
             document.getElementById("gradepred4").innerHTML = "";
      ...
      document.getElementById("gradepred").innerHTML="All entries are not filled in J-component.";
      document.getElementById("gradepred1").innerHTML = "";
      document.getElementById("gradepred2").innerHTML = "";
    document.getElementById("gradepred3").innerHTML = "";
        document.getElementById("gradepred4").innerHTML = "";
...
if(tc>0){
          if(tfat<40)
          {
            ...
            document.getElementById("gradepred4").innerHTML="Oops!You got failed in this course.";
     document.getElementById("gradepred1").innerHTML="";
       document.getElementById("gradepred").innerHTML="You got lessthan 40 marks in Theory FAT.";
         document.getElementById("gradepred2").innerHTML="";
        document.getElementById("gradepred3").innerHTML="";
          }
...
if(lc>0){
          ...
          {
            document.getElementById("gradepred2").innerHTML="You got lessthan 50 marks in Lab Component.";
     ...
     if(jc>0){
          if((r1c+r2c+r3c)<50)
          {
            document.getElementById("gradepred3").innerHTML="You got lessthan 50 marks in J- Component.";
...
if(tfat>=40 && totalmarks<50){
     ...
     document.getElementById("gradepred4").innerHTML="Oops!You got failed in this course because your Final marks are lessthan 50% of total.";
     document.getElementById("gradepred1").innerHTML="If this course is graded under Absolute grading, your grade is F.";
       document.getElementById("gradepred").innerHTML="";
         document.getElementById("gradepred2").innerHTML="";
        document.getElementById("gradepred3").innerHTML="";
      ...
      if(totalmarks>=90)
      {
       document.getElementById("gradepred4").innerHTML="Your Final marks for this course is "+totalmarks.toFixed(4)+" ~ "+Math.ceil(totalmarks);
...
document.getElementById("alertgpacal").innerHTML = "Please select the respective grade(s) for the course(s) for which credit(s) are already opted.";
...
document.getElementById("alertgpacal").innerHTML = "Please select the respective credit(s) for the course(s) for which grades(s) are already opted.";
document.getElementById("alertgpacal1").innerHTML = "";
...
if( sem1g<0 || sem2g<0 || sem3g<0 || sem4g<0 || sem5g<0 || sem6g<0 || sem7g<0 || sem8g<0 || sem9g<0 || sem10g<0 || sem11g<0 || sem12g<0){
  ...
  document.getElementById("alertcgpacal").innerHTML = "Please check your respective GPA entries; shouldn't be negative,any special charecters,text.";
  ...
  document.getElementById("alertcgpacal").innerHTML = "Please check the CREDITS and GPA limits; (0< CREDITS <=50)&(0< GPA <=10)";
  document.getElementById("alertcgpacal1").innerHTML = "";
}
    ...
    if(cgpafinal>=9){
      ...
      document.getElementById("alertcgpacal").innerHTML = "Please enter your semester wise credits and GPA.";
      document.getElementById("alertcgpacal1").innerHTML = "";
    }
    else{
    document.getElementById("alertcgpacal").innerHTML ="Your CGPA is "+cgpafinal.toFixed(4);
...
if((x<=0 || gpa<=0 || cc<=0 || nc<=0)){
  document.getElementById("iestcgpa").innerHTML = "Please check your entries; shouldn't be zero, negative, any special charecters, text or empty.";
  document.getElementById("iestcgpa1").innerHTML = "";

}
else if(x>10||gpa>10){
  document.getElementById("iestcgpa").innerHTML = "Please check your entries; Average limit(0< GPA or CGPA <=10).";
  document.getElementById("iestcgpa1").innerHTML = "";

}
else if(cc>300||nc>50){
  document.getElementById("iestcgpa").innerHTML = "Please check your entries; Credit limitation(1<= Credits Completed <=300 & 1<= Credits this sem <=50 ).";
  document.getElementById("iestcgpa1").innerHTML = "";
  ...
  if(estnum1<=0){
   ...
   document.getElementById("iestcgpa1").innerHTML = "";
    ...
    document.getElementById("iestcgpa").innerHTML =" Invalid input;Please check your entries.";
...
if((x<=0 || gpa<=0 || cc<=0 || nc<=0)){
  document.getElementById("estcgpa").innerHTML = "Please check your entries; shouldn't be zero, negative, any special charecters, text or empty.";
  document.getElementById("estcgpa1").innerHTML = "";

}
else if(x>10||gpa>10){
  document.getElementById("estcgpa").innerHTML = "Please check your entries; Average limit(0< GPA or CGPA <=10).";
  document.getElementById("estcgpa1").innerHTML = "";

}
else if(cc>300||nc>50){
  document.getElementById("estcgpa").innerHTML = "Please check your entries; Credit limitation(1<= Credits Completed <=300 & 1<= Credits Taken <=50 ).";
  document.getElementById("estcgpa1").innerHTML = "";
  ...
  if(isNaN(estnum1)){
    document.getElementById("estcgpa").innerHTML = "Kindly fill all the entries.";
document.getElementById("estcgpa1").innerHTML = "Happy Learning :) ";
   ...
   document.getElementById("estcgpa1").innerHTML = "";
    ...
    document.getElementById("estcgpa1").innerHTML = "Just missed. You are at it. All the best !";
...
document.getElementById("cresult2").innerHTML = "Please check your entries,shouldn't be negative.";
...
document.getElementById("cbar").style.width = 0+"%";
  ...
  if(num4>100){
    document.getElementById("cresult2").innerHTML = "Please check your entries.";
...
document.getElementById("result2").innerHTML = "Please check your entries,shouldn't be negative;non zero total classes or empty.";
...
document.getElementById("bar").style.width = 0+"%";
  ...
  num4 = num4 || 0;
  if(num4>100){
    document.getElementById("result2").innerHTML = "Please check your entries.";
